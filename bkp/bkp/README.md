...
A demo trabalha com o banco `iceberg_prod.governo_mg`, incluindo tabelas como:

- `iceberg_prod.governo_mg.beneficios`
- `iceberg_prod.governo_mg.beneficios_particionados`
- `iceberg_prod.governo_mg.beneficios_staging`
